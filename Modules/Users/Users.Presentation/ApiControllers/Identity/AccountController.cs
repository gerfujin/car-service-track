...
public class AccountController : ControllerBase
{
        ...
        int expiresInSeconds)
    {
        ...
        // register user (no inline refresh token — stored in module schema after creation)
        appUser = new AppUser()
        {
        ...
        // Create the initial refresh token in the Users module schema
    ...
    )
    {
        ...
        // load and compare refresh tokens (module schema)
        var refreshTokenResult = await _refreshTokens.RotateForRefreshAsync(appUser.Id, tokenRefreshInfo.RefreshToken);
        ...
        LogoutInfo logout)
    {
        ...
        await _refreshTokens.RemoveForLogoutAsync(userId, logout.RefreshToken);
        var deleteCount = await _refreshTokens.SaveChangesAsync();
