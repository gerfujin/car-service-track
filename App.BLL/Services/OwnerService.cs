...
public class OwnerService : IOwnerService
{
    ...
    public OwnerService(IAppUnitOfWork uow)
    {
        _uow = uow;
    }
    ...
    public async Task<BllOwner> EnsureForUserAsync(Guid appUserId, string fallbackUserName)
    {
        ...
        // Stage a new Owner — BaseEntity.Id = Guid.NewGuid() is assigned on construction,
        // so Id is valid before SaveChangesAsync. EF will insert Owner before Vehicle (FK order).
