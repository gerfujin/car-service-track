...
- Name: vehicles.spec.ts >> Vehicle CRUD >> Create vehicle via UI → appears in vehicle list
- Location: e2e\tests\vehicles.spec.ts:48:7
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e25]:
      - generic [ref=e26]:
        ...
        - textbox [ref=e28]: e2e-vehicles-1779388560937@test.com
      - generic [ref=e29]:
