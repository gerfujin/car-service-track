...
- Name: e2e\tests\auth.spec.ts >> Authentication >> Navigating to /vehicles without auth redirects to /login
- Location: e2e\tests\auth.spec.ts:96:7
...
Call log:
  - navigating to "/vehicles", waiting until "load"
