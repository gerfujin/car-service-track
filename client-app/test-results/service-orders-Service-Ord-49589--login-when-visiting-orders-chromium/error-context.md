...
- Name: service-orders.spec.ts >> Service Orders >> Unauthenticated user is redirected to /login when visiting /orders
- Location: e2e\tests\service-orders.spec.ts:121:7
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e25]:
      - generic [ref=e26]:
        ...
        - textbox [ref=e28]: e2e-orders-1779388623950@test.com
      - generic [ref=e29]:
