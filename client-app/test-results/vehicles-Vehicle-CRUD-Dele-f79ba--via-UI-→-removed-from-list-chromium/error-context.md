...
- Name: vehicles.spec.ts >> Vehicle CRUD >> Delete vehicle via UI → removed from list
- Location: e2e\tests\vehicles.spec.ts:120:7
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e25]:
      - generic [ref=e26]:
        ...
        - textbox [ref=e28]: e2e-vehicles-1779388623949@test.com
      - generic [ref=e29]:
