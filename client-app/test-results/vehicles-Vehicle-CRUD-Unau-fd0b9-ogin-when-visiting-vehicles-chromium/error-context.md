...
- Name: vehicles.spec.ts >> Vehicle CRUD >> Unauthenticated user is redirected to /login when visiting /vehicles
- Location: e2e\tests\vehicles.spec.ts:143:7
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e25]:
      - generic [ref=e26]:
        ...
        - textbox [ref=e28]: e2e-vehicles-1779388637972@test.com
      - generic [ref=e29]:
