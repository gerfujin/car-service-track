...
- Name: service-orders.spec.ts >> Service Orders >> Create service order via UI → redirected to order detail page
- Location: e2e\tests\service-orders.spec.ts:68:7
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e25]:
      - generic [ref=e26]:
        ...
        - textbox [ref=e28]: e2e-orders-1779388595716@test.com
      - generic [ref=e29]:
