...
- Name: auth.spec.ts >> Authentication >> Navigating to /vehicles without auth redirects to /login
- Location: tests\auth.spec.ts:96:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:81/vehicles
Call log:
  - navigating to "http://localhost:81/vehicles", waiting until "load"
